...
public class QuadraticProbing {
    ...
    // Rehash
    // Rehashing means that we are going to create a new hashtable with 2x size
    // and we are going to insert all the elements from the current hashtable into the new hashtable.
